...
;INSERT INTO ps_migration(id, down_migrations) VALUES(11, '[{"sql":"DROP TABLE ps_stream_subscriptions"},{"sql":"DELETE FROM ps_migration WHERE id >= 11"}]')
;INSERT INTO ps_migration(id, down_migrations) VALUES(12, '[{"sql":"ALTER TABLE ps_buckets DROP COLUMN downloaded_size"},{"sql":"DELETE FROM ps_migration WHERE id >= 12"}]')
;INSERT INTO ps_migration(id, down_migrations) VALUES(13, '[{"sql":"ALTER TABLE ps_updated_rows RENAME TO ps_updated_rows_13"},{"sql":"CREATE TABLE ps_updated_rows(\n  row_type TEXT,\n  row_id TEXT,\n  PRIMARY KEY(row_type, row_id)) STRICT, WITHOUT ROWID"},{"sql":"INSERT INTO ps_updated_rows(row_type, row_id)\n  SELECT row_type, row_id FROM ps_updated_rows_13\n  GROUP BY row_type, row_id"},{"sql":"DROP TABLE ps_updated_rows_13"},{"sql":"DELETE FROM ps_migration WHERE id >= 13"}]')
''',
};
...
;INSERT INTO ps_buckets(name, last_applied_op, last_op, target_op, add_checksum, pending_delete) VALUES
  ...
  ('b2', 0, 0, 0, 1005, 0)
;INSERT INTO ps_oplog(bucket, op_id, op, row_type, row_id, key, data, hash, superseded) VALUES
  ('$local', 1, 4, 'lists', 'l1', null, null, 0, 0),
  ('$local', 1, 4, 'lists', 'l2', null, null, 0, 0),
  ('$local', 1, 4, 'todos', 't1', null, null, 0, 0),
  ('$local', 1, 4, 'todos', 't2', null, null, 0, 0),
  ('b1', 1, 3, 'todos', 't1', '', '{}', 100, 0),
  ('b1', 2, 3, 'todos', 't2', '', '{}', 20, 0),
  ('b2', 3, 3, 'lists', 'l1', '', '{}', 3, 0)
''',

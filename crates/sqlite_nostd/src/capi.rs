...
pub use crate::bindings::{
    ...
    SQLITE_PREPARE_NO_VTAB as PREPARE_NO_VTAB, SQLITE_PREPARE_NORMALIZE as PREPARE_NORMALIZE,
    SQLITE_PREPARE_PERSISTENT as PREPARE_PERSISTENT, SQLITE_UTF8 as UTF8, sqlite_int64 as int64,
...
mod aliased {
    ...
    pub use crate::bindings::{
        ...
        sqlite3_prepare_v3 as prepare_v3, sqlite3_randomness as randomness,
        sqlite3_realloc as realloc, sqlite3_realloc64 as realloc64, sqlite3_reset as reset,
...
pub fn realloc(ptr: *mut c_void, size: usize) -> *mut u8 {
    if usize::BITS == 64 {
        unsafe { invoke_sqlite!(realloc64, ptr, size as uint64) as *mut u8 }
    } else {
        unsafe { invoke_sqlite!(realloc, ptr, size as c_int) as *mut u8 }
    }
}

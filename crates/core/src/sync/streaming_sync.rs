...
use crate::{
    ...
    error::SQLiteError,
    kv::client_id,
    sync::{checkpoint::OwnedBucketChecksum, interface::StartSyncStreamOptions},
};
...
impl SyncIterationHandle {
    ...
    fn new(db: *mut sqlite::sqlite3, options: StartSyncStreamOptions) -> Result<Self, ResultCode> {
...
struct StreamingSyncIteration {
    ...
    options: StartSyncStreamOptions,
